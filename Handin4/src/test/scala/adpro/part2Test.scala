...
class part2Test extends FlatSpec with Checkers {
  ...
  behavior of "doublelinkedlist, not property testing"
  behavior of "add right"

  it should "add 100 elements to the right" in {
...
//    }
  ...
  it should "add 1000 elements to the right" in  {
...
//  }
  ...
  it should "add 1000 elements to the left" in  {
    var dll = mutable.DoubleLinkedList.empty[Int]
    //forAll { (i: Int) => {
    while (dll.size < 1000) {
      dll = 1+:dll
...
//  }
  ...
  it should "remove 1000 elements to the left" in  {
...
//  }
  ...
  it should "remove 1000 elements to the right" in  {
    var dll = mutable.DoubleLinkedList.range(0,1000)
    //forAll { (i: Int) => {
    while (dll.size > 0) {
      dll = dll.dropRight(1)
